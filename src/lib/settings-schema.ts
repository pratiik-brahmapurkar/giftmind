...
export const SETTINGS_SCHEMA: SettingDef[] = [
  ...
  { key: "feature_chat_finder", type: "boolean", category: "flags", default: false, description: "Enable Ask GiftMind chat-first gift discovery", adminOnly: false, superadminOnly: true },
  ...
  providerChain("provider_chain_chat_finder", ["groq-llama", "gemini-flash", "claude-haiku"], "Provider fallback chain for chat-first gift discovery"),
