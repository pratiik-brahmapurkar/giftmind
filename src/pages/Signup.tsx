    ...
    <AuthLayout>
      <Card className={`border-border/50 shadow-lg transition-transform ${shake ? "animate-shake" : ""}`}>
        ...
        <CardContent className="space-y-4">
          ...
          {/* Google OAuth */}
          <Button variant="outline" className="w-full border-[1.5px]" onClick={handleGoogleSignup}>
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs text-neutral-600 font-medium">
          ...
          <form onSubmit={handleSignup} className="space-y-6">
            <div className="flex flex-col gap-[6px]">
              ...
              <Input id="fullName" placeholder="John Doe" value={fullName} onChange={(e) => setFullName(e.target.value)} required className="border-[1.5px] placeholder:text-neutral-500" />
            </div>
            ...
            <div className="flex flex-col gap-[6px]">
              ...
              <Input id="email" type="email" placeholder="you@example.com" value={email}
                ...
                className={cn("border-[1.5px] placeholder:text-neutral-500", emailError ? "border-destructive" : "")}
              />
            ...
            <div className="flex flex-col gap-[6px]">
              ...
              <Input id="password" type="password" placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} required className="border-[1.5px] placeholder:text-neutral-500" />
              {password && (
            ...
            <div className="flex flex-col gap-[6px]">
              ...
              <Input id="confirmPassword" type="password" placeholder="••••••••" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} required className="border-[1.5px] placeholder:text-neutral-500" />
            </div>

            {/* Referral code — toggle or auto-shown from URL */}
            {!showReferral ? (
              <button type="button" onClick={() => setShowReferral(true)}
                className="text-xs text-amber-600 font-medium hover:text-amber-700 underline underline-offset-2 transition-colors">
              ...
              <div className="flex flex-col gap-[6px]">
                ...
                <div className="relative">
                  <Input id="referral" placeholder="e.g. abc123" value={referralCode}
                    ...
                    readOnly={!!refFromUrl}
                    className={cn("border-[1.5px] placeholder:text-neutral-500", referralCode.length >= 4 ? "pr-8 border-success" : "", !!refFromUrl && "bg-muted cursor-not-allowed")} />
            ...
            <div className="flex items-start gap-2 pt-2">
              <Checkbox id="terms" checked={agreed} onCheckedChange={(v) => setAgreed(v === true)} className="border-[1.5px] mt-0.5" />
